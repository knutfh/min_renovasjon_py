MUNICIPALITY_CODE_URL = 'https://register.geonorge.no/api/sosi-kodelister/kommunenummer.json'
KOMTEK_API_BASE_URL = 'https://norkartrenovasjon.azurewebsites.net/proxyserver.ashx'
KOMTEK_API_ENDPOINT_URL = 'https://komteksky.norkart.no/komtek.renovasjonwebapi/api/'
